 ...
 * Provides a comprehensive GUI with landing simulation and optimization details.
 */
public class ScheduleVisualizer {
    ...
    public static void visualizeSchedule(ALPSolution solution) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            tabbedPane.addTab("Schedule Timeline", new ImageIcon(), new JScrollPane(schedulePanel), "Gantt chart visualization of landing schedule");
            tabbedPane.addTab("Simulation", new ImageIcon(), simulationPanel, "Animated simulation of aircraft landings");
            tabbedPane.addTab("Statistics", new ImageIcon(), new JScrollPane(statsPanel), "Detailed optimization statistics");
     ...
     */
    private static JPanel createControlPanel(ALPSolution solution, SchedulePanel schedulePanel, SimulationPanel simulationPanel) {
        ...
        speedCombo.addActionListener(e -> {
            ...
            switch (selected) {
                case "0.5x": animationSpeed[0] = 2; break;
                case "1x": animationSpeed[0] = 1; break;
                case "2x": animationSpeed[0] = 1; break;
                case "5x": animationSpeed[0] = 1; break;
                case "10x": animationSpeed[0] = 1; break;
            }
        });
    ...
    private static JPanel createStatsPanel(ALPSolution solution) {
        ...
        if (problemType.contains("Problem 1")) {
            ...
            addStatField(summaryPanel, "On-Time Aircraft", String.valueOf(instance.getNumAircraft() - earlyAircraft - lateAircraft));
        ...
        protected void paintComponent(Graphics g) {
            ...
            for (int i = 0; i < numAircraft; i++) {
                ...
                if (Math.abs(landingTime - currentTime) <= 1) {
                    ...
                    // Draw info tooltip
                    String infoText = "A" + (i+1) + " | Time: " + landingTime + " | Target: " + aircraft.getTargetLandingTime();
    ...
    private static class SimulationPanel extends JPanel {
        ...
        private void drawAircraftInfo(Graphics2D g2d, int aircraftId, double x, double y) {
            ...
            String[] infoLines = {
                ...
                "Status: " + (timeToLanding > 0 ? 
                             "Approaching (" + timeToLanding + " time units)" : 
            ...
            int boxX = (int)x + 20;
            if (boxX + boxWidth > getWidth()) boxX = (int)x - boxWidth - 20;
            
            int boxY = (int)y - boxHeight/2;
            if (boxY < 0) boxY = 0;
            if (boxY + boxHeight > getHeight()) boxY = getHeight() - boxHeight;
